...
class SequentialFedLTA(functional.Functional):
    ...
    def __init__(self, layers=None, name=None, proto_index=-2):
        ...
        Args:
          ...
          return_proto: Optional bool that indicates whether of not to return prototype in call function.
          If False, call returns output. If True, call returns (output, proto)
          proto_index: Optional int that indicates the index of the prototype layer. Pattern is -2, which means that the
          layer before the last one generates the protoype.
        """
        ...
        base_layer.keras_api_gauge.get_cell("SequentialFedLTA").set(True)
