...
def bar_plot(df, base_dir, file_name, x_column, y_column, title, hue=None, hue_order=None, y_lim=False, y_min=0, y_max=1, log_scale=False, sci=False, x_order=None):
    ...
    figure = sns.barplot(x=x_column, y=y_column, hue=hue, data=df, hue_order=hue_order, errorbar=None, order=x_order).set_title(title)
