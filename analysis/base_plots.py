...
def bar_plot(df, base_dir, file_name, x_column, y_column, title, hue=None, hue_order=None, y_lim=False, y_min=0, y_max=1, log_scale=False, sci=False):
    ...
    figure = sns.barplot(x=x_column, y=y_column, hue=hue, data=df, hue_order=hue_order).set_title(title)
...
def box_plot(df, base_dir, file_name, x_column, y_column, title, hue=None, log_scale=False, ax=None, type=None, hue_order=None, y_lim=False, y_min=0, y_max=1, n=None, x_order=None):
    Path(base_dir).mkdir(parents=True, exist_ok=True)
    ...
    if type is not None:
        ...
        figure = sns.boxplot(x=x_column, y=y_column, data=df, hue=hue, ax=ax, palette=palette, hue_order=hue_order, order=x_order).set_title(title)
    else:
        figure = sns.boxplot(x=x_column, y=y_column, data=df, hue=hue, ax=ax, hue_order=hue_order, order=x_order).set_title(title)
