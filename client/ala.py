...
class ALA:
    ...
    def adaptive_local_aggregation(self,
        ...
        try:
            ...
            # [rand_idx:rand_idx+rand_num],
            rand_loader = DataLoader(self.train_data, batch_size=self.batch_size, drop_last=True)
            # print(rand_loader.dataset)


            # obtain the references of the parameters
            params_g = [torch.from_numpy(i) for i in global_model]
            params = [i for i in local_model.parameters()]

            # deactivate ALA at the 1st communication iteration
            print("shape1: ", params_g[0].shape, " shape2: ", params[0].shape)
            ...
            print("tamanho: ", len(params_p))

            return params_p

        except Exception as e:
            print("adaptive local aggregation")
