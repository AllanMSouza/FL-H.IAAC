...
class SimulationFL():
	...
	def __init__(self, n_clients, algorithm, model_name, strategy_name, dataset, local_epochs, rounds, poc, decay, non_iid):
...
def main():
	...
	simulation = SimulationFL(int(opt.n_clients), opt.algorithm, opt.model_name,  opt.strategy_name, opt.dataset,
