...
from server.common_base_server import CDAFedAvgBaseServer
...
class CDAFedAvgBaseServerWithFedPredictDynamic(CDAFedAvgBaseServer):
	...
	def __init__(self,
		...
		self.create_folder_fedpredict(strategy_name)
	...
	def create_folder_fedpredict(self, strategy_name):
	...
	def aggregate_fit(self, server_round, results, failures):
		...
		if self.use_gradient:
			...
			print("lle: ", len(self.previous_global_parameters), server_round)
