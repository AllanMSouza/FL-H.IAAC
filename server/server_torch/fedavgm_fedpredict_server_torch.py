from server.common_base_server import FedPredictBaseServer, FedAvgMBaseServerTorch
...
class FedAvgM_FedPredictServerTorch(FedAvgMBaseServerTorch, FedPredictBaseServer):
