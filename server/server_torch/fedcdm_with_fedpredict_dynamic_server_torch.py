...
from server.common_base_server import FedCDMWithFedPredictDynamicBaseServer
...
class FedCDMWithFedPredictDynamicServerTorch(FedCDMWithFedPredictDynamicBaseServer):
