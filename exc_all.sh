...
python3 exec_simulation.py --experiment_id=2 --type="torch" > execution_log/experiment_2.txt 2>&1

#echo "Executing experiment 3..."
#python3 exec_simulation.py --experiment_id=3 --type="torch" > execution_log/experiment_3.txt 2>&1

#echo "Executing experiment 4..."
#python3 exec_simulation.py --experiment_id=4 --type="torch" > execution_log/experiment_4.txt 2>&1
#
#echo "Executing experiment 5..."
#python3 exec_simulation.py --experiment_id=5 --type="torch" > execution_log/experiment_5.txt 2>&1
