...
STRATEGIES_FOR_ANALYSIS 		= ['FedPredict', 'FedAVG', 'FedProto', 'FedAvgM', 'FedClassAvg', 'FedPer']
STRATEGIES_TO_EXECUTE 			= ['FedPredict', 'FedAVG', 'FedProto', 'FedAvgM', 'FedClassAvg', 'FedPer']
